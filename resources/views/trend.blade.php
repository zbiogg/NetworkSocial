    ...
    <div class="row">
        ...
        <div class="c-main col" id="c_main">
                <div style="display: flex; background-color: #fff; border-radius: 5px; margin-top: 15px;align-items: center;padding: 10px">
                    <span>Xem các bài viết nổi bật trong: </span>		
                    <div class="center ml-1">
                    <select onchange="selectViewTrend(value)" name="sources" id="sources" class="custom-select sources" placeholder="Source Type">
